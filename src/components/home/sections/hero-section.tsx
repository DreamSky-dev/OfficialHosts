      ...
      <div className="relative h-screen overflow-hidden md:sticky md:top-0">
        ...
        >
          <div className="pointer-events-auto flex w-full max-w-2xl flex-col items-center pt-24 text-center md:pt-28">
            ...
            <div
              className="relative mt-8 grid w-full max-w-md grid-cols-2 overflow-hidden rounded-full border border-white/25 bg-white/10 p-1 backdrop-blur-sm"
              role="group"
              aria-label="How to start your site"
            >
              <div
                aria-hidden
                className="pointer-events-none absolute top-1 bottom-1 left-1 w-[calc(50%-0.25rem)] rounded-full bg-white shadow-sm transition-transform duration-200 ease-out"
                style={{
                  transform:
                    listingMode === "fresh" ? "translateX(100%)" : "none",
                }}
              />
              <button
                type="button"
                onClick={() => setListingMode("paste")}
                className={`relative z-10 flex items-center justify-center gap-2 rounded-full px-4 py-2.5 text-sm font-medium transition-colors ${listingMode === "paste" ? "text-foreground" : "text-white/80 hover:text-white"}`}
              >
              ...
              <button
                ...
                className={`relative z-10 flex items-center justify-center gap-2 rounded-full px-4 py-2.5 text-sm font-medium transition-colors ${listingMode === "fresh" ? "text-foreground" : "text-white/80 hover:text-white"}`}
              >
            ...
            {listingMode === "paste" ? (
              ...
              <Button
                ...
                asChild
              >
                <Link href="/dashboard/add?method=fresh">Get Start Fresh Now</Link>
              </Button>
            )}
          </div>
        </div>
